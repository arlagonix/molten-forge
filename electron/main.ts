...
const FILE_REPLACE_TEXT_TOOL_NAME = "file_replace_text";
const FILE_CREATE_TOOL_NAME = "file_create";
const FILE_DELETE_TOOL_NAME = "file_delete";
...
function readRequiredRawString(args: unknown, key: string) {
